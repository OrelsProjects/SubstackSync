...
import { Site, StatusType, datadogLogs } from "@datadog/browser-logs";
  ...
  try {
    ...
    datadogLogs.init({
      ...
      site: process.env.NEXT_PUBLIC_DATADOG_SITE
        ? (process.env.NEXT_PUBLIC_DATADOG_SITE as Site)
        : undefined,
...
const log = (
  ...
  try {
    ...
    const rawMessage = `${message} ${logItem ? JSON.stringify(logItem) : ""} ${
