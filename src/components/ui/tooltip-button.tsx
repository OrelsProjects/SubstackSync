      ...
      <TooltipProvider>
        ...
        >
          ...
          {disabledTooltip && props.disabled && (
            <TooltipTrigger className={cn("absolute top-0 right-0 w-full h-full", className)}>
              {/* small invisible span */}
              <span className="text-xs text-muted-foreground invisible w-full h-full">
                {disabledTooltip}
              </span>
            </TooltipTrigger>
          )}
